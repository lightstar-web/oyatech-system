            ...
            <div class="topbar-brand flex items-center">
                <div
                    ...
                    <a href="/" class="flex items-center font-bold text-lg  dark:text-white">
                        <img src="{{ asset('assets/images/logo-sm.png') }}" alt="" class="ltr:mr-2 rtl:ml-2 inline-block h-6" style="min-width: 40px; min-height: 40px;" />
                ...
                <div>
                    <div class="dropdown relative ltr:mr-4 rtl:ml-4">
                        <button type="button"
                            ...
                            aria-expanded="true">
                            @if(Auth::user()->avatar)
                            <img class="inline-block h-10 w-10 rounded-full ring-2 ring-white dark:ring-zinc-500 mr-2" src="{{ asset(Auth::user()->avatar) }}" alt="">
                            @else
                            <img class="inline-block h-10 w-10 rounded-full ring-2 ring-white dark:ring-zinc-500 mr-2" src="{{ asset('assets/images/users/default.png') }}" alt="">
                            @endif
                            <span class="fw-medium hidden xl:block">{{ Auth::user()->nickname }}</span>
                            <i class="mdi mdi-chevron-down align-bottom hidden xl:block"></i>
                        </button>
                        <div class="dropdown-menu absolute top-0 z-50 hidden w-40 list-none rounded bg-white shadow dark:bg-zinc-800" id="profile/log">
                ...
                <ul class="metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="javascript: void(0);" aria-expanded="false"
                            ...
                            <span data-key="t-auth"> プロジェクト管理</span>
                        </a>
                        <ul>
                            <li>
                            ...
                            <li>
                                <a href="{{ route('projectMana.index') }}"
                                    class="pl-14 pr-4 py-2 block text-[13.5px] font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">プロジェクト一覧</a>
                            </li>
                        </ul>
                    </li>
                    @endif
                    ...
                    <li>
                        <a href="{{ route('userMana.index') }}"
                            ...
                            <span data-key="t-dashboard"> ユーザー管理</span>
                        </a>
                    </li>
                    @endif
                </ul>
